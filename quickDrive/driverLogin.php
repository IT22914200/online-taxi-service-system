...
.form button[type="submit"]:hover {
  background-color: #45a049;
    ...
    <form action="includes/driverLogin.inc.php" method="post">
        <input type="text" id="fname" name="driverUsername" placeholder="Email / Username">
    ...
    ?>
   <p>New Here ? <a href="driverSignup.php">Register.</a></p>
